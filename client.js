...
if (script === undefined) {
  script = document.querySelector('script[src^="https://stewwan.github.io/utterances/client.js"],script[src^="http://localhost:4000/client.js"]');
}
...
script.insertAdjacentHTML("afterend", "<div class=\"utterances\">\n    <iframe class=\"utterances-frame\" title=\"Comments\" scrolling=\"no\" src=\"" + url + "?" + deparam_1.param(attrs) + "\"></iframe>\n  </div>");
...
},{"./deparam":"deparam.ts"}]},{},["client.ts"], null)
